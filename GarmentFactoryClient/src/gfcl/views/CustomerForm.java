...
public class CustomerForm extends javax.swing.JFrame {
    ...
    public CustomerForm() {
        try {
            ...
            ImageIcon icon = new ImageIcon(getClass().getResource("/gfcl/images/icon.jpg"));
            ...
            JTextComponent editorSearchNICCombo = (JTextComponent) customerCombo.getEditor().getEditorComponent();
            editorSearchNICCombo.addKeyListener(new KeyClass(customerCombo));
    ...
    private void initComponents() {
        ...
        jScrollPane2.setViewportView(address_text);
